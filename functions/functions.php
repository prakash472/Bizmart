...
function getProducts(){
	...
	<br>
	<img src='admin/product_images/$pro_image' width='180' height='180' align='middle' id='products_box'/><br><br>
...
function getCatPro(){
	...
	<h3 id='products_title'>$pro_title</h3>
	<br>
	<img src='admin/product_images/$pro_image' width='180' height='180' align='centre' id='products_box'/><br><br>
...
$sel_pro_price="select * from products where product_id='$p_id'";
...
echo"";
	...
	$q="insert into cart (p_id,id_address,qty,total) values ('$p_id','$ip_address',1,'$pro_price')"    ;

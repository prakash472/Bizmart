...
<div id="left_sidebar">
<div id="sidebar_title">Buy Or Sell </div>
<ul id="cats">
<li><a href="index.php?insert_product">Post Product</a></li>
</ul>
...
<?php
if(!isset($_SESSION['email'])){
echo"<a href='customer_main_login.php' style='color:#00F;'>Login</a>";
}
else{
...
<div id="products_box">
<div>
          <form action="seller_login.php" method="post" autocomplete="off">

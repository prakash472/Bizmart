...
$get_pro="Select * from retailer_products where retailer_id='$retailer_id'";
...
<td align="center">
<?php
$get_sold="select * from retailer_pending_order where product_id='$pro_id' and retailer_id='$retailer_id'";

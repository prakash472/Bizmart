...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="admin">
    ...
    <header class="admin__statusbar flex--center">
	  ...
	  <?php
	  $retailer_email1=$_SESSION['retailer_email'];
      $get_retialer_name="Select * from retailer where email='$retailer_email1'";
	  $run_email=mysqli_query($con,$get_retialer_name);
	  $row_title=mysqli_fetch_array($run_email);
	  $retailer_title=$row_title['retailer_title'];
	  echo "$retailer_title";
	  ?>
	  </span>
    </header>

...
<div class="body-content">
  <div class="module">
    ...
    <form class="form" action="retailer_main_signup.php" method="post" enctype="multipart/form-data" autocomplete="off">
...
$password_2 = $_POST['password_2'];
 ...
 // Check
  $result = mysqli_query($con,"SELECT * FROM retailer WHERE email='$email'");

  if ($password_1 != $password_2) {
      array_push($errors,"Passwords do not match!");
   }
 if ( $result->num_rows > 0 ) {
  array_push($errors,"Retailer with this email already exists!");
...
$password_1=md5($password_1);
    ...
    $sql = "INSERT INTO retailer (retailer_title, email, password, contact_num,address,profile_pic)
           VALUES ('$retailer_name','$email','$password_1', '$contact_num','$address','$profile_pic')";
			move_uploaded_file($pic_temp,"images/$profile_pic");

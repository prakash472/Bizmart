...
if(isset($_GET['edit_cat'])){
	$cat_edit_id=$_GET['edit_cat'];
	 $edit_cat="select * from retailer_categories where cat_id='$cat_edit_id' and retailer_id='$retailer_id'";
...
if(isset($_POST['update_cat'])){
	...
	$update_cat="update retailer_categories set cat_title='$cat_title2' where cat_id='$cat_edit_id' and retailer_id='$retailer_id'";

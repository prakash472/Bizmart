...
Explore Your Own Site Here With Us
 </div>
</div>
<!-- Header2 ends-->
...
<ul class="nav">
    ...
    <li>
       ...
       <li>   
            ...
            <li><a href="retailer/admin/retailer_main_login.php">Login</a></li>
            <li><a href="retailer/admin/retailer_main_signup.php">Sign up</a> 
       </li>
        </ul>
    </li>
    <li><a href="seller/index.php">Sell</a>
    <ul>
    	<li><a href="seller/insert_product.php">Sell Product</a>
